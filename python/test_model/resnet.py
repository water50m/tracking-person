...
while cap.isOpened():
    ...
    # ตัวแปรเก็บเวลาเริ่มต้นไว้ที่ 0 สำหรับเฟรมที่ถูก Skip
    ...
    if frame_count % (skip_frames + 1) == 1:
        ...
        if results[0].boxes:
            ...
            # ⏱️ จับเวลา: เตรียมรูป (Crop + Resize + HSV)
            ...
            if crops_for_resnet:
                ...
                # ⏱️ จับเวลา: จัดการข้อมูล Track History & สี
        ...
        # 📊 พิมพ์รายงาน Profiling ออกทาง Console (เฉพาะเฟรมที่มีการคำนวณ AI)
